...
const urlsWithNoLoginToFUGA = ['/filemanagerapp/api/users', '/filemanagerapp/api/firebase']
const urlsNotApiThatNeedLoginToFuga = ['/filemanagerapp/api/firebase/fuga', '/filemanagerapp/api/royalties/fuga'];
